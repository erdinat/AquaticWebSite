...
Kullanıcı güncel resmi iletişim bilgilerini verdi: 3 gerçek Kocaeli-bölgesi adresi (Merkez Ofis, Ar-Ge Ofisi, Fabrika), 4 telefon numarası (2 Tel&Faks + 2 Mobil), ve `.kz` için ayrı bir e-posta (`bilgi@aquatic.com.kz`). Eskiden sitede Kocaeli/İstanbul/Almatı (Kazakistan) olmak üzere 3 farklı şehir/ofis vardı — yeni bilgiler bunların yerini aldı (İstanbul ve Almatı ofisleri artık listede yok).
